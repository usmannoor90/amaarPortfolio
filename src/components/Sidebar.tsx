      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: -200 }}
            className="px-6  z-[100] py-10 bg-[#0000002f] border-r-solid border-r-[1px] border-[#ffffff4d] max-w-[14rem] lg:w-fit  fixed lg:relative  h-screen left-0 flex flex-col justify-between"
          >
